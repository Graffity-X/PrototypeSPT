...
namespace SixDegrees
{
    public class SDMesh : MonoBehaviour
    {
        ...
        private string url = "https://5vuc1ejovk.execute-api.ap-northeast-1.amazonaws.com/obj/";
        ...
        public void  MeshConvert()
        {
            ...
            Debug.Log("meshの個数" + chunks.Count);
            foreach (SDMeshChunk chunk in chunks.Values)
            {
                json += ObjExporter.MeshToString(chunk.meshFilter) + "\n";
            }
